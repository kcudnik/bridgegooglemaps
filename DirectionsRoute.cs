namespace Bridge.Google.Maps
{
    ...
    public class DirectionsRoute
    {
        ...
        /// <summary>
        ///     The total fare for the whole transit trip. Only applicable to
        ///     transit requests.
        /// </summary>
        ...
        ///     about the steps of which it is composed. There will be one leg for
        ///     each waypoint or destination specified. So a route with no
        ///     waypoints will contain one DirectionsLeg and a route with one
        ///     waypoint will contain two.
        /// </summary>
        public DirectionsLeg[] Legs;

        /// <summary>
        ///     An array of LatLngs representing the entire course of this route.
        ///     The path is simplified in order to make it suitable in contexts
        ///     where a small number of vertices is required (such as Static Maps
        ///     API URLs).
        /// </summary>
        [Name("overview_path")]
        ...
        ///     re-ordered permutation of the input waypoints. For example, if the
        ///     input was:
        ///     Origin: Los Angeles
        ...
        ///     Destination: New York
        ///     then this field will be an Array containing the values [2, 0, 1].
        ///     Note that the numbering of waypoints is zero-based.
