namespace Bridge.Google.Maps
{
    ...
    /// <summary>
    /// This object defines the clickable region of a marker image for browsers
    /// other than Internet Explorer. The shape consists of two properties -
    /// type and coord - which define the non-transparent region of an image. A
    /// MarkerShape object is not required on Internet Explorer since the
    /// browser does not fire events on the transparent region of an image by
    /// default.
    /// </summary>
    [External]
    [ObjectLiteral]
    public class MarkerShape
    {
        ...
        /// - circle: coords is [x1, y1, r] where x1, y2 are the coordinates of
        /// the center of the circle, and r is the radius of the circle.
        /// - poly: coords is [x1, y1, x2, y2...xn, yn] where each x, y pair
        /// contains the coordinates of one vertex of the polygon.
        /// - rect: coords is [x1, y1, x2, y2] where x1, y1 are the coordinates
        /// of the upper-left corner of the rectangle and x2, y2 are the
