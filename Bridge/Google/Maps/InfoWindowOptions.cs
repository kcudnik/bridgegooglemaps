namespace Bridge.Google.Maps
{
    ...
    public class InfoWindowOptions
    {
        ...
        /// a plain-text string, or a string containing HTML. The InfoWindow
        /// will be sized according to the content. To set an explicit size for
        /// the content, set content to be a HTML element with that size.
        /// </summary>
        public Union<string, Node> Content;
        ...
        /// anchored. If an InfoWindow is opened with an anchor, the
        /// pixelOffset will be calculated from the anchor's anchorPoint
        /// property.
        /// </summary>
        public Size PixelOffset;

        /// <summary>
        /// The LatLng at which to display this InfoWindow. If the InfoWindow
        /// is opened with an anchor, the anchor's position will be used
        /// instead.
        /// </summary>
        ...
        /// values. By default, InfoWindows are displayed according to their
        /// latitude, with InfoWindows of lower latitudes appearing in front of
        /// InfoWindows at higher latitudes. InfoWindows are always displayed
        /// in front of markers.
        /// </summary>
        public int ZIndex;
    }
