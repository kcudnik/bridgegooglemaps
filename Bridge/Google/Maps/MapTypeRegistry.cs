namespace Bridge.Google.Maps
{
    ...
    {
        /// <summary>
        /// The MapTypeRegistry holds the collection of custom map types
        /// available to the map for its use. The API consults this registry
        /// when providing the list of avaiable map types within controls, for
        /// example.
        /// </summary>
