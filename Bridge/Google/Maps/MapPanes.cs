namespace Bridge.Google.Maps
{
    ...
    /// They are listed below with 'Pane 0' at the bottom and 'Pane 4' at the
    /// top.
    /// </summary>
    [External]
    [ObjectLiteral]
    public class MapPanes
    {
        ...
        /// <summary>
        /// This pane is the lowest pane and is above the tiles. It may not
        /// receive DOM events. (Pane 0).
        /// </summary>
        public Element MapPane;

        /// <summary>
        /// This pane contains markers. It may not receive DOM events. (Pane
        /// 2).
        /// </summary>
