namespace Bridge.Google.Maps.Drawing
{
    ...
    public class DrawingManagerOptions
    {
        ...
        /// DrawingManager. The center and radius properties are ignored, and
        /// the map property of a new circle is always set to the
        ...
        /// <summary>
        /// The Map to which the DrawingManager is attached, which is the Map
        ...
        /// DrawingManager. The position property is ignored, and the map
        ...
        /// DrawingManager. The paths property is ignored, and the map property
        /// of a new polygon is always set to the DrawingManager's map.
        /// </summary>
        public PolygonOptions PolygonOptions;

        /// <summary>
        /// Options to apply to any new polylines created with this
        /// DrawingManager. The path property is ignored, and the map property
        /// of a new polyline is always set to the DrawingManager's map.
        /// </summary>
        public PolylineOptions PolylineOptions;

        /// <summary>
        /// Options to apply to any new rectangles created with this
        /// DrawingManager. The bounds property is ignored, and the map
        /// property of a new rectangle is always set to the DrawingManager's
        /// map.
        /// </summary>
