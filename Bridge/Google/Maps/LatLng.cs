namespace Bridge.Google.Maps
{
    ...
    /// if the value specified is less than -90, it will be set to -90. And if
    /// the value is greater than 90, it will be set to 90.
    ...
    /// range.For example, a value of -190 will be converted to 170. A value of
    /// 190 will be converted to -170. This reflects the fact that longitudes
    ...
    /// Most methods that accept LatLng objects also accept a LatLngLiteral
    /// object, so that the following are equivalent:
    /// map.setCenter(new google.maps.LatLng(-34, 151));
    /// map.setCenter({lat: -34, lng: 151});
    /// The constructor also accepts literal objects, and converts them to
    /// instances of LatLng:
    ...
    {
        /// <summary>
        /// Creates a LatLng object representing a geographic point. Latitude
        /// is specified in degrees within the range [-90, 90]. Longitude is
        /// specified in degrees within the range [-180, 180]. Set noWrap to
        /// true to enable values outside of this range. Note the ordering of
