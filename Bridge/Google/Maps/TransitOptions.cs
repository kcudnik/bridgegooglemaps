namespace Bridge.Google.Maps
{
    ...
    /// <summary>
    ///     The TransitOptions object to be included in a DirectionsRequest when
    ///     the travel mode is set to TRANSIT.
    /// </summary>
    [External]
    [ObjectLiteral]
    public class TransitOptions
    {
        ...
        ///     January 1970. If neither departure time nor arrival time is
        ///     specified, the time is assumed to be "now".
        /// </summary>
        ...
        /// <summary>
        ///     A preference that can bias the choice of transit route, such as
        ///     less walking. If no preference is given, the API returns the
        ///     default best route.
        /// </summary>
