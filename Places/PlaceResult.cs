namespace Bridge.Google.Maps.Places
{
    ...
    public class PlaceResult
    {
        ...
        /// <summary>
        ///     The Place's phone number in international format. International
        ...
        /// <summary>
        ///     The Place's name. Note: In the case of user entered Places, this is
        ///     the raw text, as typed by the user. Please exercise caution when
        ///     using this data, as malicious users may try to use it as a vector
        ///     for code injection attacks (See
        ///     http://en.wikipedia.org/wiki/Code_injection).
        /// </summary>
        public string Name;

        /// <summary>
        ///     A flag indicating whether the Place is permanently closed. If the
        ///     place is not permanently closed, the flag is not present in search
        ///     or details responses.
        /// </summary>
        ...
        /// <summary>
        ///     URL of the official Google page for this place. This is the
        ///     Google-owned page that contains the best available information
        ///     about the place.
        /// </summary>
        public string Url;

        /// <summary>
        ///     The offset from UTC of the Place's current timezone, in minutes.
        ///     For example, Sydney, Australia in daylight savings is 11 hours
        ///     ahead of UTC, so the utc_offset will be 660. For timezones behind
        ///     UTC, the offset is negative. For example, utc_offest is -60 for
        ///     Cape Verde.
        /// </summary>
        [Name("utc_offset")]
        ...
        /// <summary>
        ///     A fragment of the Place's address for disambiguation (usually
